...
#define CONFIGURATION "--prefix=/usr/local/ffmpegtoolkit --codecsdir=/usr/local/ffmpegtoolkit/lib/codecs/ --extra-cflags=-I/usr/local/ffmpegtoolkit/include/ --extra-ldflags=-L/usr/local/ffmpegtoolkit/lib --with-freetype-config=/usr/local/ffmpegtoolkit/bin/freetype-config --yasm=/usr/local/ffmpegtoolkit/bin/yasm"

#define MPLAYER_DATADIR "/usr/local/ffmpegtoolkit/share/mplayer"
#define MPLAYER_CONFDIR "/usr/local/ffmpegtoolkit/etc/mplayer"
#define MPLAYER_LIBDIR "/usr/local/ffmpegtoolkit/lib"
...
#undef CONFIG_XMMS
#define BINARY_CODECS_PATH "/usr/local/ffmpegtoolkit/lib/codecs/"
