...
int GP3VADxEncoder_Interface_Encode( void *st, enum Mode mode, Word16 *speech,
...
int IF2VADxEncoder_Interface_Encode( void *st, enum Mode mode, Word16 *speech,
...
int ETSIVADxEncoder_Interface_Encode( void *st, enum Mode mode, Word16 *speech,
